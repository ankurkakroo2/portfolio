...
The experiments were small, but gave me a peek at what's possible. I've worked with embedded systems before—it's tedious. Writing all that code, testing it, etc. But this was seamless. Just told the agent what to do and it interfaced and loaded the program into the microcontroller directly. Rapidly did 4-5 experiments. Pretty fun ones. Barrier to entry just vanished.
